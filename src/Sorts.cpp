...
std::vector<int> Container::PrivateMergeSort(std::vector<int>::iterator left_iterator, std::vector<int>::iterator right_iterator)  // 1 3 4 5 6
{
...
{
    m_small_vector = PrivateMergeSort(m_small_vector.begin(), m_small_vector.end() - 1);
}
